...
class GoogleAuthenticator {
	...
	static $SECRET_COMPONENTS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567';
	...
	public function getCode($secret, $time = null) {
		...
		$base32 = new FixedBitNotation(5, self::$SECRET_COMPONENTS, TRUE, TRUE);
	...
	public function getUrl($user, $hostname, $secret) {
		...
		$encoder = sprintf("https://chart.googleapis.com/chart?chs=200x200&chld=M|0&cht=qr&chl=%s", $url);
