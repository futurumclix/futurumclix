...
class ForumHelper extends AppHelper {
    ...
    public function forumIcon($forum, array $options = array()) {
        $options = $options + array(
            'open' => 'forum-icon-open',
            'closed' => 'forum-icon-closed',
            'new' => 'forum-icon-new'
        );
        $icon = 'open';
        $tooltip = '';
        ...
        return $this->_View->element('tooltip_tag', array('icon' => $options[$icon], 'tooltip' => $tooltip));
    }
    ...
    public function topicIcon($topic, array $options = array()) {
        $options = $options + array(
            'open' => 'forum-topic-open',
            'open-hot' => 'forum-topic-open-hot',
            'closed' => 'forum-topic-closed',
            'new' => 'forum-topic-new',
            'new-hot' => 'forum-topic-new-hot',
            'sticky' => 'forum-topic-sticky',
            'important' => 'forum-topic-important',
            'announcement' => 'forum-topic-announcement'
        );
    ...
    /**
     * Returns a country flag based on user's location
     *
    ...
    public function getCountryFlag($location) {
        ...
        return $this->_View->element('country_flag', array('image' => 'flags'.DS.$code.'.png', 'country' => $location));
    }
