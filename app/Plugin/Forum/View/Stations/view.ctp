		...
		<div class="panel-body table-responsive">
			...
			<?php } ?>
				...
				if ($topics) {
					...
					<h5 class="text-xs-center padding30"><?php echo __d('forum', 'There are no topics within this forum'); ?></h5>
