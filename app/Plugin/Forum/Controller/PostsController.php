...
class PostsController extends ForumAppController {
     ...
     * @type array
     */
    public $components = array('Utility.AjaxHandler', 'Report');
    ...
    public function report($id) {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Report->reportItem($data['type'], $this->Post, $id, $data['comment'], $user_id)) {
                $this->Session->setFlash(__d('forum', 'You have successfully reported this post! A moderator will review this post and take the necessary action.'), 'flash');
