...
/**
 * ExplorerAdsVisitedAd Model
 *
 * @property Ad $Ad
 * @property User $User
 */
class ExplorerAdsVisitedAd extends AppModel {
 ...
 * @return boolean
 */
	public function clearVisitedAds($user_id = null, $mode = null) {
		if($mode === null) {
 ...
 * @return array
 */
	public function getDateVisitedByUser($user_id, $order = 'DESC') {
		$this->recursive = -1;
