				...
				<div class="panel">
					<div class="padding30-col">
						...
						<div class="row padding30-col">
							<div class="col-md-12">
								<h5 class="padding30-bottom"><?=__('Clicks statistics for: "%s".', $ad['ExplorerAd']['title'])?></h5>
								<?=
								...
								<?php if($geo_targetting): ?>
									<h5 class="margin30-top padding30-bottom"><?=__('Geographic statistics for: "%s".', $ad['ExplorerAd']['title'])?></h5>
