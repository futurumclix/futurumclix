<div class="col-md-12">
	<div class="title">
		<h2><?=__d('admin', 'Login Ads settings')?></h2>
	</div>
	...
	<div class="tab-content">
		<div id="details" class="tab-pane fade in active">
			...
			<?=$this->AdminForm->create('Settings', array('class' => 'form-horizontal'))?>
				<div class="form-group">
					<label class="col-sm-4 control-label"><?=__d('admin', 'Enable Login Ads')?></label>
					<div class="col-sm-8">
						<?=
							$this->AdminForm->input('loginAdsActive', array(
								'type' => 'checkbox',
								'data-trigger' => 'focus',
								'data-toggle' => 'popover',
								'data-placement' => 'top',
								'data-content' => __d('admin', 'Check if you want to turn on Login Ads'),
							))
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=
							$this->AdminForm->input('loginAdsAutoApprove', array(
								'type' => 'checkbox',
								'data-trigger' => 'focus',
								'data-toggle' => 'popover',
								'data-placement' => 'top',
				...
				<div class="form-group">
					<label class="col-sm-4 control-label"><?=__d('admin', 'Max Ads Per Box')?></label>
					<div class="col-sm-8">
						<?=
							$this->AdminForm->input('loginAdsPerBox', array(
								'type' => 'number',
								'data-trigger' => 'focus',
								'data-toggle' => 'popover',
								'data-placement' => 'top',
								'data-content' => __d('admin', 'How much ads do you want to show per login ads box'),
							))
						?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?=
							$this->AdminForm->input('loginAdsTitleMaxLen', array(
								'type' => 'number',
								'min' => 0,
								'step' => 1,
								'max' => 128,
				...
				<div class="form-group">
					<label class="col-sm-4 control-label"><?=__d('admin', 'Show Login Ads')?></label>
					<div class="col-sm-8">
						<?=$this->AdminForm->input('loginAdsShowMode')?>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							...
							<?=
								$this->AdminForm->input('Settings.loginAdsSize.width', array(
									'type' => 'number',
									'min' => 1,
									'step' => 1,
								))
					...
					<div class="col-sm-4">
						<div class="input-group">
							...
							<?=
								$this->AdminForm->input('Settings.loginAdsSize.height', array(
									'type' => 'number',
									'min' => 1,
									'step' => 1,
								))
		...
		<div id="packages" class="tab-pane fade in">
			...
			<?=
				$this->AdminForm->create('LoginAdsPackage', array(
					'url' => array('controller' => 'login_ads', '#' => 'packages'),
			...
			?>
				...
				<div id="packagesBody">
					<?php if(isset($this->request->data['LoginAdsPackage'][0]['id'])): ?>
						<?=$this->AdminForm->input('LoginAdsPackage.0.id')?>
					<?php endif; ?>
					<div class="form-group" id="exampleRow">
						<label class="col-sm-1 control-label">1.</label>
						<div class="col-sm-3">
							<?=$this->AdminForm->input('LoginAdsPackage.0.type', array('options' => $packagesTypes))?>
						</div>
						<div class="col-sm-4">
							<?=$this->AdminForm->input('LoginAdsPackage.0.amount')?>
						</div>
						<div class="col-sm-3">
							<div class="input-group"><?=$this->AdminForm->input('LoginAdsPackage.0.price')?></div>
						</div>
						<div class="col-sm-1">
							<?=
								$this->AdminForm->postLink('<i class="fa fa-minus-circle fa-lg" data-toggle="tooltip" data-placement="top" title="'.__d('admin', 'Click To Remove This Package').'"></i>',
									array('action' => 'delete_package', $this->request->data['LoginAdsPackage'][0]['id']),
									array('escape' => false),
									__d('admin', 'Are You sure you want to delete # %s?', $this->request->data['LoginAdsPackage'][0]['id'])
								)
							?>
						</div>
					</div>
					<?php for($i = 1; $i < $packetsNo; $i++): ?>
						<div class="form-group">
							<?=$this->AdminForm->input("LoginAdsPackage.$i.id")?>
							<label class="col-sm-1 control-label"><?=($i+1).'.'?></label>
							<div class="col-sm-3"><?=$this->AdminForm->input("LoginAdsPackage.$i.type", array('options' => $packagesTypes))?></div>
							<div class="col-sm-4"><?=$this->AdminForm->input("LoginAdsPackage.$i.amount")?></div>
							<div class="col-sm-3">
								<div class="input-group"><?=$this->AdminForm->input("LoginAdsPackage.$i.price")?></div>
							</div>
							<div class="col-sm-1">
								<?=
									$this->AdminForm->postLink('<i class="fa fa-minus-circle fa-lg" data-toggle="tooltip" data-placement="top" title="'.__d('admin', 'Click To Remove This Package').'"></i>',
										array('action' => 'delete_package', $this->request->data['LoginAdsPackage'][$i]['id']),
										array('escape' => false),
										__d('admin', 'Are You sure you want to delete # %s?', $this->request->data['LoginAdsPackage'][$i]['id'])
									)
								?>
							</div>
						</div>
