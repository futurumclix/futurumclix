<div class="container advertise">
	<div class="row">
		<div class="col">
			<h2 class="text-xs-center"><?=__('You are buying Express Advertisement')?></h2>
		</div>
	</div>
	<script>
						...
						<?=$this->UserForm->create(false)?>
							<fieldset class="form-group">
								<div class="input-group">
									...
									?>
									<div id="titleCounter" class="input-group-addon"> <?=isset($this->request->data['ExpressAd']['title']) ? strlen($this->request->data['ExpressAd']['title']) : 0?> / <?=$settings['titleLen']?></div>
								</div>
							</fieldset>
							<?php if($settings['descShow']): ?>
								<fieldset class="form-group" id="description">
									<div class="input-group">
										...
										?>
										<div id="descCounter" class="input-group-addon"><?=isset($this->request->data['ExpressAd']['description']) ? strlen($this->request->data['ExpressAd']['description']) : 0?> / <?=$settings['descLen']?></div>
									</div>
								</fieldset>
							<?php endif; ?>
							<fieldset class="form-group">
							...
							<fieldset class="form-group">
								<div class="input-group">
									<span class="input-group-addon">
										<?=$this->UserForm->input('ExpressAd.hide_referer')?>
									</span>
