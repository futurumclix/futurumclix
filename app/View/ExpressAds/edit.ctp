			...
			<div class="col-md-12 padding30-sides">
				...
				<div class="panel">
					<div class="padding30-col">
						<div class="col-md-12">
							<h5><?=__('Express Advertisement Panel')?></h5>
						</div>
						<?=
										...
										<fieldset class="form-group">
											<div class="input-group">
												...
												<?=
													...
													?>
												<div id="titleCounter" class="input-group-addon"><?=isset($this->request->data['ExpressAd']['title']) ? strlen($this->request->data['ExpressAd']['title']) : 0?> / <?=$titleMax?></div>
											</div>
										</fieldset>
										<fieldset class="form-group">
											<div class="input-group">
												...
												<?=
													...
													?>
												<div id="descCounter" class="input-group-addon"><?=isset($this->request->data['ExpressAd']['description']) ? strlen($this->request->data['ExpressAd']['description']) : 0?> / <?=$descMax?></div>
											</div>
										</fieldset>
										<fieldset class="form-group">
											<div class="input-group">
