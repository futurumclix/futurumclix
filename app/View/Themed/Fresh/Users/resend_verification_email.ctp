		...
		<div class="uk-grid">
			<div class="uk-width-1-1">
				<ul class="uk-breadcrumb">
					...
					<li class="uk-active"><?=__('Resend Verification E-mail')?></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="uk-container content">
	<div class="uk-grid">
		<div class="uk-width-1-1">
			<?=$this->Notice->show()?>
			<h2 class="uk-text-center"><?=__('Resend Verification E-mail')?></h2>
			...
			<div class="uk-margin">
				<button class="uk-button uk-button-primary"><?=__('Resend Verification E-mail')?></button>
			</div>
