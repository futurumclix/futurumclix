...
<div id="reportSuccess" uk-alert style="display:none"><?=__d('ad_grid', 'Your report is received, thanks for your contribution.')?></div>
<div id="reportFail" uk-alert style="display:none"><?=__d('ad_grid', 'We could not receive your report, please try again later.')?></div>
<?=$this->UserForm->create(false, array('id' => 'reportForm'))?>
<div class="uk-modal-body uk-form-horizontal">
	<div class="uk-margin">
		<label class="uk-form-label"><?=__d('ad_grid', 'Reason')?></label>
