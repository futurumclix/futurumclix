	...
	<div class="panel-body uk-overflow-auto">
		...
		<table class="uk-table uk-table-small">
			...
			<tbody>
				...
				<h5 class="uk-text-center uk-margin-top"><?php echo __d('forum', 'There are no topics within this forum'); ?></h5>
				<?php } ?>
			</tbody>
		</table>
		<?php if ($topics) {echo $this->element('Forum.pagination', array('class' => 'insidenav'));} ?>
	</div>
</div>
