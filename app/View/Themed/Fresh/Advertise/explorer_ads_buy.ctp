		...
		<div class="uk-grid">
			<div class="uk-width-1-1">
				<ul class="uk-breadcrumb">
					...
					<li class="uk-active"><?=__('You are buying Explorer Advertisement')?></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="uk-card uk-card-body uk-card-default uk-margin-top">
				...
				<div class="uk-margin">
					<label class="uk-form-label">
						<?=__('Title')?>
						<div id="titleCounter" class="uk-badge"> <?=isset($this->request->data['ExplorerAd']['title']) ? strlen($this->request->data['ExplorerAd']['title']) : 0?> / <?=$settings['titleLen']?></div>
					</label>
					<?=
				...
				<div class="uk-margin" id="description">
					<label class="uk-form-label">
						<?=__('Description')?>
						<div id="descCounter" class="uk-badge"><?=isset($this->request->data['ExplorerAd']['description']) ? strlen($this->request->data['ExplorerAd']['description']) : 0?> / <?=$settings['descLen']?></div>
					</label>
					<?=
				...
				<div class="uk-margin">
					<label>
					<?=$this->UserForm->input('ExplorerAd.hide_referer', array('class' => 'uk-checkbox'))?>
