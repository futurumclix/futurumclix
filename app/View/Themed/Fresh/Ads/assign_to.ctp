...
<div class="uk-container dashpage">
	<div class="uk-grid">
		...
		<div class="uk-width-3-4@m">
			...
			<h5><?=__('Sorry, you do not have any PTC packages for this ad. You will be automatically redirected to purchase advertisement exposures after 5 seconds.')?></h5>
			<?php $this->Js->buffer("
				window.setTimeout(function() {
				window.location.href = '".Router::url(array('controller' => 'ads_category_packages', 'action' => 'buy', $activeAd['Ad']['ads_category_id']))."';
				}, 5000);
				")?>
			<?php else: ?>
