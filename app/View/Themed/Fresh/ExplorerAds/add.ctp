...
<div class="uk-container dashpage">
	<div class="uk-grid">
		...
		<div class="uk-width-3-4@m">
			...
			<?=
				$this->UserForm->create('ExplorerAd', array(
			...
			<div class="uk-margin">
				<label class="uk-form-label">
					<?=__('Description')?>
					<div id="descCounter" class="uk-badge"><?=isset($this->request->data['ExplorerAd']['description']) ? strlen($this->request->data['ExplorerAd']['description']) : 0?> / <?=$descMax?></div>
				</label>
				<?=
