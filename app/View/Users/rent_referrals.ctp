			...
			<div class="col-md-12 padding30-sides">
				...
				<div class="panel">
					<div class="padding30-col">
						...
						<div class="col-sm-1 moneypanel moneypanelicon">
							<a title="<?=__('Already rented referrals / your referral limit')?>" data-toggle="tooltip" data-placement="top"><i class="fa fa-info"></i></a>
						</div>
